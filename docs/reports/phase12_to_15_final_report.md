...
Located at [`app/technical_specs/models.py`](file:///E:/Bis-system/app/technical_specs/models.py) and [`app/technical_specs/extractor.py`](file:///E:/Bis-system/app/technical_specs/extractor.py):
...
Located at [`app/technical_specs/matcher.py`](file:///E:/Bis-system/app/technical_specs/matcher.py):
...
Located at [`app/tender_analysis/models.py`](file:///E:/Bis-system/app/tender_analysis/models.py) and [`app/tender_analysis/extractor.py`](file:///E:/Bis-system/app/tender_analysis/extractor.py):
...
Located at [`app/document_intelligence/classifier.py`](file:///E:/Bis-system/app/document_intelligence/classifier.py):
...
Located at [`app/document_intelligence/extractor.py`](file:///E:/Bis-system/app/document_intelligence/extractor.py):
...
Located at [`app/document_intelligence/matcher.py`](file:///E:/Bis-system/app/document_intelligence/matcher.py):
...
Located at [`app/applicability/evaluator.py`](file:///E:/Bis-system/app/applicability/evaluator.py):
...
Located at [`app/applicability/evaluator.py`](file:///E:/Bis-system/app/applicability/evaluator.py) and [`app/applicability/models.py`](file:///E:/Bis-system/app/applicability/models.py):
...
- **Pipeline Wiring** ([`app/rag/pipeline.py`](file:///E:/Bis-system/app/rag/pipeline.py)):
...
- **API Models & Endpoints** ([`app/models.py`](file:///E:/Bis-system/app/models.py), [`app/api/query.py`](file:///E:/Bis-system/app/api/query.py)):
  - Serializes `technical_analysis`, `tender_analysis`, `evidence_gap_report`, and `compliance_readiness` in `QueryResponse`.
- **E2E Test Suite** ([`tests/test_e2e_phases_12_to_15.py`](file:///E:/Bis-system/tests/test_e2e_phases_12_to_15.py)):
