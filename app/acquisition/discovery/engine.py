    ...
    def _seed_baseline_catalog(self) -> None:
        ...
        baseline_records = [
            ...
            StandardMetadataRecord(
                ...
                ics_code="29.060.20",
                applicable_products=["PVC Insulated Wires", "Building Wires", "Flexible Cords"],
                mandatory_qco_number="Electrical Wires, Cables and Cords QCO 2024",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=True,
                document_id="doc_pm_fcc94ef8ab898d98",
                created_at=now,
                updated_at=now,
            ),
            # 9. Motors for Submersible Pumpsets (IS 9283)
            StandardMetadataRecord(
                standard_number="IS 9283:2024",
                title="Motors for Submersible Pumpsets - Specification",
                year=2024,
                edition_or_version="Second Revision",
                status="CURRENT",
                category="Pumps & Irrigation",
                technical_committee="MED 20 - Pumps and Turbines",
                ics_code="23.080",
                applicable_products=["Submersible Motors", "Borewell Pump Motors"],
                mandatory_qco_number="Motors for Submersible Pumpsets QCO 2023",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=True,
                document_id="doc_pm_596865ed5110bfc1",
                created_at=now,
                updated_at=now,
            ),
            # 10. Surgical Rubber Gloves (IS 13422)
            StandardMetadataRecord(
                standard_number="IS 13422:2024",
                title="Surgical Rubber Gloves - Specification",
                year=2024,
                edition_or_version="First Revision",
                status="CURRENT",
                category="Medical Rubber Goods",
                technical_committee="PCD 13 - Rubber and Rubber Products",
                ics_code="11.140",
                applicable_products=["Sterile Surgical Gloves", "Latex Medical Examination Gloves"],
                mandatory_qco_number="Medical Textiles and Rubber Examination Goods QCO 2024",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=True,
                document_id="doc_pm_14591ea9a32d45bc",
                created_at=now,
                updated_at=now,
            ),
            # 11. Structural Steel (IS 2062)
            StandardMetadataRecord(
                standard_number="IS 2062:2011",
                title="Hot Rolled Medium and High Tensile Structural Steel - Specification",
                year=2011,
                edition_or_version="Seventh Revision",
                status="CURRENT",
                category="Steel & Metallurgy",
                technical_committee="MTD 04 - Wrought Steel Products",
                ics_code="77.140.10",
                applicable_products=["Steel Plates", "Steel Beams", "Structural Sections", "Columns"],
                mandatory_qco_number="Steel and Steel Products QCO 2020",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 12. Portland Pozzolana Cement (IS 1489 Part 1)
            StandardMetadataRecord(
                ...
                ics_code="91.100.10",
                applicable_products=["PPC Cement", "Flyash Cement"],
                mandatory_qco_number="Cement (Quality Control) Order 2021",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 13. Ordinary Portland Cement (IS 269)
            StandardMetadataRecord(
                standard_number="IS 269:2015",
                title="Ordinary Portland Cement - Specification",
                year=2015,
                edition_or_version="Sixth Revision",
                status="CURRENT",
                category="Construction & Cement",
                technical_committee="CED 02 - Cement and Concrete",
                ics_code="91.100.10",
                applicable_products=["OPC 33 Grade", "OPC 43 Grade", "OPC 53 Grade"],
                mandatory_qco_number="Cement (Quality Control) Order 2021",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
            ...
            # 14. Safety Footwear (IS 15844)
            StandardMetadataRecord(
                standard_number="IS 15844:2010",
                title="Sports Footwear - Specification",
                year=2010,
                edition_or_version="First Edition",
                status="CURRENT",
                category="Footwear & Leather",
                technical_committee="CHD 17 - Leather and Footwear",
                ics_code="61.060",
                applicable_products=["Sports Shoes", "Athletic Footwear"],
                mandatory_qco_number="Footwear made from Leather and other Materials QCO 2020",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 15. Industrial Safety Shoes (IS 17043)
            StandardMetadataRecord(
                standard_number="IS 17043:2018",
                title="Personal Protective Equipment - Safety Footwear",
                year=2018,
                edition_or_version="First Edition",
                status="CURRENT",
                category="Footwear & Industrial Safety",
                technical_committee="CHD 17 - Leather and Footwear",
                ics_code="13.340.50",
                applicable_products=["Industrial Safety Boots", "Steel Toe Shoes"],
                mandatory_qco_number="Personal Protective Equipment - Footwear QCO 2020",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 16. Solar Terrestrial Modules (IS 14286)
            StandardMetadataRecord(
                ...
                ics_code="27.160",
                applicable_products=["Solar PV Panels", "Crystalline Silicon Modules"],
                mandatory_qco_number="Solar Photovoltaics CRO 2017",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 17. Packaged Drinking Water (IS 14543)
            StandardMetadataRecord(
                ...
                technical_committee="FAD 14 - Drinks and Drinking Water",
                ics_code="13.060.20",
                applicable_products=["Bottled Drinking Water", "20L Water Jars"],
                mandatory_qco_number="Packaged Drinking Water QCO 2021",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 18. Potable Drinking Water (IS 10500)
            StandardMetadataRecord(
                ...
                technical_committee="FAD 14 - Drinks and Drinking Water",
                ics_code="13.060.20",
                applicable_products=["Municipal Tap Water", "Piped Drinking Water"],
                mandatory_qco_number="National Drinking Water Quality Mission Standards",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 19. Polyethylene Pipes for Water (IS 4984)
            StandardMetadataRecord(
                standard_number="IS 4984:2016",
                title="Polyethylene Pipes for Water Supply - Specification",
                year=2016,
                edition_or_version="Fifth Revision",
                status="CURRENT",
                category="Plastics & Piping",
                technical_committee="CED 50 - Plastic Piping Systems",
                ics_code="23.040.20",
                applicable_products=["HDPE Pipes", "PE 80 Pipes", "PE 100 Water Pipes"],
                mandatory_qco_number="Polyethylene Pipes for Water Supply QCO 2023",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 20. EV Conductive Charging (IS 17017 Part 1)
            StandardMetadataRecord(
                standard_number="IS 17017 (Part 1):2018",
                title="Electric Vehicle Conductive AC and DC Charging System - Part 1: General Requirements",
                year=2018,
                edition_or_version="First Edition",
                status="CURRENT",
                category="Automotive & Electric Mobility",
                technical_committee="ETD 51 - Electrotechnology in Mobility",
                ics_code="43.120",
                applicable_products=["EV Chargers", "AC EVSE", "DC Fast Chargers"],
                mandatory_qco_number="Electric Vehicle Charging Systems QCO 2022",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 21. Self-Ballasted LED Lamps (IS 16102 Part 1)
            StandardMetadataRecord(
                ...
                technical_committee="ETD 23 - Electric Lamps and Luminaires",
                ics_code="29.140.01",
                applicable_products=["LED Bulbs", "Retrofit LED Lamps"],
                mandatory_qco_number="Electronics and IT Goods CRO 2021",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 22. Transformer Operated Smart Meters (IS 16444 Part 2)
            StandardMetadataRecord(
                standard_number="IS 16444 (Part 2):2017",
                title="a.c. Static Transformer Operated Watt-Hour and VAR-Hour Smart Meters, Class 0.2S, 0.5S and 1.0S - Specification",
                year=2017,
                edition_or_version="First Edition",
                status="CURRENT",
                category="Electrical & Smart Grid",
                technical_committee="ETD 13 - Electrical Appliances and Electricity Meters",
                ics_code="17.220.20",
                applicable_products=["CT/PT Operated Smart Meters", "Commercial Feeder Meters"],
                mandatory_qco_number="Smart Meters QCO 2020",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=True,
                document_id="doc_pm_a668874801ec2610",
                created_at=now,
                updated_at=now,
            ),
            # 23. IT Equipment Safety (IS 13252 Part 1)
            StandardMetadataRecord(
                ...
                technical_committee="LITD 08 - Audio, Video and Multimedia",
                ics_code="35.020",
                applicable_products=["Laptops", "Tablets", "Servers", "Printers", "Power Adapters"],
                mandatory_qco_number="Electronics and IT Goods Compulsory Registration Order 2012/2021",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 24. Technical Textiles - Bullet Resistant Jackets (IS 17051)
            StandardMetadataRecord(
                standard_number="IS 17051:2018",
                title="Bullet Resistant Jackets - Performance Requirements",
                year=2018,
                edition_or_version="First Edition",
                status="CURRENT",
                category="Textiles & Defence",
                technical_committee="TXD 32 - Specialised Technical Textiles",
                ics_code="59.080.30",
                applicable_products=["Body Armour", "Bullet Resistant Vests"],
                mandatory_qco_number="Protective Textiles (Quality Control) Order 2023",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
            ...
            # 25. Automotive Safety Glazing (IS 2553 Part 2)
            StandardMetadataRecord(
                ...
                technical_committee="TED 05 - Automotive Safety",
                ics_code="43.040.60",
                applicable_products=["Laminated Windshields", "Toughened Side Windows"],
                mandatory_qco_number="Safety Glass (Quality Control) Order 2020",
                is_mandatory=True,
                source_url="https://standardsbis.bsbedge.com",
                license_status=LicenseStatus.LICENSED,
                full_text_available=False,
